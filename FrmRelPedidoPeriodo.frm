...
Begin VB.Form FrmRelPedidoPeriodo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Pedido Período"
   ClientHeight    =   2910
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   ...
   End
End
Attribute VB_Name = "FrmRelPedidoPeriodo"
...
End If
  ...
  LcFormula = LcFormula & "{Pedido.DTEMIS} >=" & LcChav1 & " And {Pedido.DTEMIS} <=" & LcChav2


'== fim filtro
'== fim filtro
CryRelatorio.DiscardSavedData = True
lctitulo = "Relatório de Pedidos por Periodo."
...
CryRelatorio.WindowTitle = lctitulo
 ...
 CryRelatorio.Formulas(3) = "titulo='Relatório de Pedido por Período'"
