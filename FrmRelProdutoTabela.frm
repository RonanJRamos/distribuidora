...
Begin VB.Form FrmRelProdutotabela 
   BackColor       =   &H00EAE8DD&
   ...
   End
End
Attribute VB_Name = "FrmRelProdutotabela"
...
LcSql = "Select Desativado,codigo,NOME,UnidMedida,Preco from produtos where nome like '" & UCase(Nome.Text) & "%'" & LcWhereDesativado & "  and Fornecedor like '" & UCase(codigofor.Text) & "%' order by codigo"
...
Do Until RsNota.EOF
    ...
    LcSql = " Insert Into relprodutos(codigo,NOME, UnidMedida,Preco,Desativado)values("
    LcSql = LcSql & "'" & RsNota!Codigo & "','" & RsNota!Nome & "',"
    LcSql = LcSql & "'" & LcUnidade & "'," & Replace(RsNota!Preco, ",", ".") & ","
...
lctitulo = "Relatorio de Produtos (Tabela)"
With Rel
'Exit Sub
