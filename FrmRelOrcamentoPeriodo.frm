...
Begin VB.Form FrmRelOrcamentoPeriodo 
   ...
   Caption         =   "Relatório de Orçamento / Vendas por Período"
   ClientHeight    =   3345
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6015
...
CryRelatorio.WindowTitle = "Relação de Orçamentos/Vendas por período"

 CryRelatorio.Formulas(0) = "Empresa='" & LcEmpresa & "'"
 CryRelatorio.Formulas(1) = "Endereco='" & LcEndereco & "'"
 CryRelatorio.Formulas(2) = "Fone='" & LcFone & "'"
 CryRelatorio.Formulas(3) = "titulo='Relatório de Orçamentos por Período'"
