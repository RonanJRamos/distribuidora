...
Begin VB.Form FrmRelProdutoNomeCod 
   BackColor       =   &H00EAE8DD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Produto por Nome - Simples"
   ClientHeight    =   4020
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7140
   ...
   End
End
Attribute VB_Name = "FrmRelProdutoNomeCod"
...
Private Rel       As New CryRelProdutoSimples
...
LcSql = "Select Desativado,codigo,NOME,UnidMedida from produtos where nome like '" & UCase(Nome.Text) & "%'" & LcWhereDesativado & " and Fornecedor like '" & UCase(codigofor.Text) & "%' order by codigo"
...
Do Until RsNota.EOF
    ...
    LcSql = " Insert Into relprodutos(codigo,NOME, UnidMedida,Desativado)values("
...
lctitulo = "Relatorio de Produtos (Simples)"
With Rel
'Exit Sub
