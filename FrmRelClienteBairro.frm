...
Begin VB.Form FrmRelClienteBairro 
   Caption         =   "Relatório de Clientes por Bairro"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6960
   ...
   End
End
Attribute VB_Name = "FrmRelClienteBairro"
...
'Abertura do relatório de vendas
    ...
    End If
    If Iniciado Then LcFormula = "{ALID001.Bairro} like '" & UCase(Nome.Text) & "*'"
    If Qualquer Then LcFormula = "{ALID001.Bairro} like '*" & UCase(Nome.Text) & "*'"
    If Igual Then LcFormula = "{ALID001.Bairro}='" & UCase(Nome.Text) & "'"
...
CryRelatorio.WindowTitle = "Clientes por Bairro"
...
CryRelatorio.Formulas(5) = "titulo='Clientes por Bairro'"
