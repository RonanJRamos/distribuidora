...
Begin VB.Form FrmRelChequeCompensado 
   Caption         =   "Relatório Cheques Compensados"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6960
   ...
   Begin VB.Label Label2 
      BackColor       =   &H00000000&
      Caption         =   "  Relatório de Cheques Compensados"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmRelChequeCompensado"
...
Dim LcEmpresa, LcEndereco, LcFone, LcVer, LcCap, LcVer1, Lccelular, Lccelular1, Lcemail As String
AbreBase
...
'Abertura do relatório de vendas
    ...
    End If
    If Iniciado Then LcFormula = "{cheques.compensado} like '" & UCase(Nome.Text) & "*'"
    If Qualquer Then LcFormula = "{cheques.compensado} like '*" & UCase(Nome.Text) & "*'"
    If Igual Then LcFormula = "{cheques.compensado}='" & UCase(Nome.Text) & "'"
    If Len(Nome.Text) > 0 Then
       CryRelatorio.SortFields(0) = "+{cheques.compensado}"
      End If
...
CryRelatorio.WindowTitle = "Cheques Compensados"
...
CryRelatorio.Formulas(5) = "titulo='Cheques Compensados'"
