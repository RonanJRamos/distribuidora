...
Begin VB.Form FrmRelChequeEntrada 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Cheques por Período"
   ClientHeight    =   2460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   ...
   End
End
Attribute VB_Name = "FrmRelChequeEntrada"
...
End If
  ...
  LcFormula = LcFormula & "{cheques.dataentrada} >=" & LcChav1 & " And {cheques.dataentrada} <=" & LcChav2
