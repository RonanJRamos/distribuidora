...
Begin VB.Form FrmRelFornecComprasPeriodo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Compras por Período - Fornecedores"
   ClientHeight    =   2460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   ...
   End
End
Attribute VB_Name = "FrmRelFornecComprasPeriodo"
...
End If
  ...
  LcFormula = LcFormula & "{ALID002.ULTCOMPRA} >=" & LcChav1 & " And {ALID002.ULTCOMPRA} <=" & LcChav2
...
CryRelatorio.WindowTitle = lctitulo
 ...
 CryRelatorio.Formulas(3) = "titulo='Relatório de Compras - Fornecedor'"
