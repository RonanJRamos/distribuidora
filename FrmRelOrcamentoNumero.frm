...
Begin VB.Form FrmRelOrcNumero 
   Caption         =   "Relatório Orçamento/Venda por Número "
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6960
   ...
   Begin VB.Label Label2 
      BackColor       =   &H00000000&
      Caption         =   "  Relatório de Orçamento/ Venda por número "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmRelOrcNumero"
...
'Abertura do relatório de vendas
    ...
    End If
    If Iniciado Then LcFormula = "{orcamento.doc} like '" & UCase(Nome.Text) & "*'"
    If Qualquer Then LcFormula = "{orcamento.doc} like '*" & UCase(Nome.Text) & "*'"
    If Igual Then LcFormula = "{orcamento.doc}='" & UCase(Nome.Text) & "'"
...
CryRelatorio.WindowTitle = "Relação de Orçamentos/Venda"
...
CryRelatorio.Formulas(5) = "titulo='Relação de Orçamentos/Venda'"
