...
Begin VB.Form FrmRelClienteEstado 
   Caption         =   "Relatório de Clientes por Estado"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6960
   ...
   End
End
Attribute VB_Name = "FrmRelClienteEstado"
...
'Abertura do relatório de vendas
    ...
    End If
    If Iniciado Then LcFormula = "{ALID001.ESTADO} like '" & UCase(Nome.Text) & "*'"
    If Qualquer Then LcFormula = "{ALID001.ESTADO} like '*" & UCase(Nome.Text) & "*'"
    If Igual Then LcFormula = "{ALID001.ESTADO}='" & UCase(Nome.Text) & "'"
...
CryRelatorio.WindowTitle = "Clientes por Estado"
...
CryRelatorio.Formulas(5) = "titulo='Clientes por Estado'"
