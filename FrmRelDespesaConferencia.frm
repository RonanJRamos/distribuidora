...
Begin VB.Form FrmRelDespesaConferencia 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Conferência de Lançamentos de Despesa"
   ClientHeight    =   2460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   ...
   End
End
Attribute VB_Name = "FrmRelDespesaConferencia"
...
End If
   ...
   ' End If
    CryRelatorio.SortFields(0) = "+{ALID014.codigo}"
  ...
  LcFormula = LcFormula & "{ALID014.DATA} >=" & LcChav1 & " And {ALID014.DATA} <=" & LcChav2
