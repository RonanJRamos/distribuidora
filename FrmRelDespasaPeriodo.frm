...
Begin VB.Form FrmRelDespesaPeriodo 
   BackColor       =   &H00E6E4D2&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Despesa por Período"
   ClientHeight    =   2460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.OptionButton OPtAbertos 
         ...
         Width           =   1095
      End
      Begin VB.OptionButton OptQuitados 
         BackColor       =   &H00E6E4D2&
         Caption         =   "Quitados"
         Height          =   195
         Left            =   120
   ...
   End
End
Attribute VB_Name = "FrmRelDespesaPeriodo"
...
End If
  ...
  LcFormula = LcFormula & "{ALID014.DTVENC} >=" & LcChav1 & " And {ALID014.DTVENC} <=" & LcChav2

If OptQuitados.Value Then
   If Len(LcFormula) > 0 Then LcFormula = LcFormula & " And "
   LcFormula = LcFormula & " {ALID014.VALPAGO}>0"
End If
If OPtAbertos.Value Then
   If Len(LcFormula) > 0 Then LcFormula = LcFormula & " And "
   LcFormula = LcFormula & " {ALID014.VALPAGO}=0"
End If
'== fim filtro
...
CryRelatorio.WindowTitle = "Despesas por Período"
CryRelatorio.DiscardSavedData = True
 ...
 CryRelatorio.Formulas(3) = "titulo='Relatório de Despesas por Período'"
