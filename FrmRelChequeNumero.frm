...
Begin VB.Form FrmRelChequeNumero 
   Caption         =   "Relatório Cheques por Número"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6960
   ...
   Begin VB.Label Label2 
      BackColor       =   &H00000000&
      Caption         =   "  Relatório de Cheques por Número"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmRelChequeNumero"
...
'Abertura do relatório de vendas
    ...
    End If
    If Iniciado Then LcFormula = "{cheques.cheque} like '" & UCase(Nome.Text) & "*'"
    If Qualquer Then LcFormula = "{cheques.cheque} like '*" & UCase(Nome.Text) & "*'"
    If Igual Then LcFormula = "{cheques.cheque}='" & UCase(Nome.Text) & "'"
    If Len(Nome.Text) > 0 Then
       CryRelatorio.SortFields(0) = "+{cheques.cheque}"
      End If
...
CryRelatorio.WindowTitle = "Cheques por Número"
...
CryRelatorio.Formulas(5) = "titulo='Cheques por Número'"
